...
def download(repo_id: str, download_dir: str, allow_patterns: Optional[List[str]] = None) -> str:
...
def main() -> int:
    ...
    path = download(repo_id=repo_id, download_dir=download_dir, allow_patterns=allow_patterns)
    print(path)
    return 0
