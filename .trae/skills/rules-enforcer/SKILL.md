---
name: "rules-enforcer"
description: "强制执行文档对齐与过程记录规则。每次开始任何实现/排障任务前调用，并在结束前复核。"
---
...
2. 追加记录到 05_recordAiOperate（只追加，不覆盖不删除）
3. 不主动提交 git
